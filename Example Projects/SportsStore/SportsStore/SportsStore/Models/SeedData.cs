        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Lifejacket", Description = "Protextive and fashionable", Category = "Watersports", Price = 48.95m },
                    ...
                    new Product { Name = "Unsteady Chair", Description = "Secretly give you opponent a disadvantage", Category = "Chess", Price = 29.95m },
